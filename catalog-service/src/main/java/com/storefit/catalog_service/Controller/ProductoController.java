...
public class ProductoController {
    ...
    @Operation(summary = "Obtener producto por ID compuesto", description = "Busca un producto por (id_categoria, id_producto)")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Encontrado", content = @Content(schema = @Schema(implementation = Producto.class))),
    ...
    @Operation(summary = "Eliminar producto", description = "Elimina el producto identificado por id_categoria e id_producto")
    @ApiResponses({
